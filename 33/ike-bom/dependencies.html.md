...
- network.ike.platform:ike-bom:pom:33 ** 
  
  | IKE Bill of Materials |
  | --- |
  | **Description: **Auto-generated BOM providing centralized dependency version management for IKE Network projects. Import this POM for version alignment without inheriting ike-parent build conventions. Generated from ike-parent's dependencyManagement by ike:generate-bom. **URL: **[https://ike.network/ike-platform/ike-bom/](https://ike.network/ike-platform/ike-bom/)[3] **Project Licenses: **[Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)[2] |
...
**Apache License, Version 2.0: **IKE Bill of Materials, IKE Build Standards
