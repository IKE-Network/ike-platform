...
public enum WsGoal {
    ...
    RELEASE_ROLLBACK_DRAFT("release-rollback-draft",
            ...
            "Preview rolling back a failed release mission's unpushed commits.",
            GoalBehavior.DRAFT),
    RELEASE_ROLLBACK_PUBLISH("release-rollback-publish",
            WsReleaseRollbackPublishMojo.class,
            "Roll back a failed release mission's unpushed commits and tags.",
    ...
    SCAFFOLD_PUBLISH("scaffold-publish", WsScaffoldPublishMojo.class,
            ...
            WorkspaceScope.BARE_AND_WORKSPACE, GoalBehavior.COORDINATING),
    SIBLING_LIST("sibling-list", SiblingListMojo.class,
            "List the primary's sibling working sets with their state (read-only).",
            WorkspaceScope.BARE_AND_WORKSPACE, GoalBehavior.READ_ONLY),
    SIBLING_REMOVE_DRAFT("sibling-remove-draft", SiblingRemoveDraftMojo.class,
            "Preview removing a sibling: what would be lost, and the lease state.",
            WorkspaceScope.BARE_AND_WORKSPACE, GoalBehavior.DRAFT),
    SIBLING_REMOVE_PUBLISH("sibling-remove-publish",
            SiblingRemovePublishMojo.class,
            "Remove a sibling working set after lease + content preflight.",
            WorkspaceScope.BARE_AND_WORKSPACE, GoalBehavior.SYNC),
