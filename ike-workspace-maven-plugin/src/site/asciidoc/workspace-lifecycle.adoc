...
workspace, the recommended approach depends on what you're bumping to:
...
align inter-subproject dep versions or update standard properties.
Pair with `ws:align-publish` afterward to converge both axes, or
prefer `ike:scaffold-publish` once #348 ships — that handles parent
