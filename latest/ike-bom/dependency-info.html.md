...
```
<dependency org="network.ike.platform" name="ike-bom" rev="149">
...
```
@Grapes(
@Grab(group='network.ike.platform', module='ike-bom', version='149')
)
```
...
```
implementation 'network.ike.platform:ike-bom:149'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.platform" % "ike-bom" % "149"
```
